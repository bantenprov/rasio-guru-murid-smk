...
miniToastr.init();
export default {
    name: "rasio-guru-murid-smk_add",
    components: {
        Datepicker
    },
    data() {
        return {
            rasio-guru-murid-smks: [],
            provinces: [],
            regencies: {},
            formstate: {},
            model: {
    ...
    methods: {
        ...
        onSubmit: function() {
            if (this.formstate.$invalid) {
              ...
              {
                axios.post("/rasio-guru-murid-smk/store", {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/rasio-guru-murid-smk/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/rasio-guru-murid-smk/create'
                  }
                },
                window.location.href = '#/admin/rasio-guru-murid-smk/create')
        ...
        back() {
            window.location = '#/admin/rasio-guru-murid-smk';
        }
    },
    mounted: function() {
        axios.get("/rasio-guru-murid-smk/create").then(response => {
