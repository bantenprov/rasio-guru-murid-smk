    ...
    <div class="row">
      <div class="col-lg-6 mb-3">
        <div class="card h-100" style="color: #fff; background-color: #2196F3;">
          <div class="card-body">
            <rasio-guru-murid-smk-bar-03></rasio-guru-murid-smk-bar-03>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      </div><!-- /col -->
      <div class="col-lg-6 mb-3">
        <div class="card h-100" style="color: #fff; background-color: #4CAF50;">
          <div class="card-body">
            <rasio-guru-murid-smk-pie-03></rasio-guru-murid-smk-pie-03>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      </div><!-- /col -->
    </div><!-- /.row -->
    ...
    <div class="row">
      <div class="col-lg-8 mb-3">
        <div class="card h-100" style="color: #fff; background-color: #009688;">
          ...
          <div class="card-body">
            <rasio-guru-murid-smk-bar-01></rasio-guru-murid-smk-bar-01>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      </div><!-- /col -->
    ...
    <div class="row">
      <div class="col-lg-6 mb-3">
        <div class="card h-100" style="color: #fff; background-color: #F44336;">
          ...
          <div class="card-body">
            <rasio-guru-murid-smk-pie-02></rasio-guru-murid-smk-pie-02>
          </div><!-- /.card-body -->
        </div><!-- /.card -->
      </div><!-- /.col -->
      <div class="col-lg-6 mb-3">
